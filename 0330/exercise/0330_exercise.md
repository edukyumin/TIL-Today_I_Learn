1. intro/settings.py
   ...
   SECRET_KEY = '+rq&z(*yq=f1y!hp$7ceh&-t7x3l^x(2w4+jep85o%k$9p6yc+'
       ...
       <nav class="navbar navbar-expand-lg navbar-light bg-dark ">
         ...
         <div class="collapse navbar-collapse" id="navbarNav">
           <ul class="navbar-nav ml-auto">
             <li class="nav-item">
               <a class="nav-link text-white" href="#">Card</a>
             </li>
             <li class="nav-item">
...
![card](0330_exercise.assets/card.JPG)

![community](0330_exercise.assets/community.JPG)